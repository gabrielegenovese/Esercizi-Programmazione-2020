/*
Definire le strutture dati necessarie per rappresentare una playlist di un servizio digitale di streaming. Una playlist `e una lista
di canzoni e ogni canzone ha un titolo, una durata (in secondi), il numero totale di riproduzioni fatte e il numero di ascoltatori
che l’hanno riprodotta. Definire le seguenti funzioni:
